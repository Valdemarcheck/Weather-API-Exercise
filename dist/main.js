/******/ (() => {
  ...
  \****************************/
      /***/ (
        ...
        /* harmony import */ var _textTranslator__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./textTranslator */ "./src/classes/textTranslator.js"
          );
        /* harmony import */ var _localStorageManager__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./localStorageManager */ "./src/classes/localStorageManager.js"
          );
        /* harmony import */ var _inputGetter__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./inputGetter */ "./src/classes/inputGetter.js"
          );
        /* harmony import */ var _URLMaker__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./URLMaker */ "./src/classes/URLMaker.js");
        /* harmony import */ var _dataFetcher__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ./dataFetcher */ "./src/classes/dataFetcher.js"
          );
        /* harmony import */ var _errorNotifier__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! ./errorNotifier */ "./src/classes/errorNotifier.js"
          );
        /* harmony import */ var _jsonParser__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! ./jsonParser */ "./src/classes/jsonParser.js"
          );
        /* harmony import */ var _dataRenderer__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(
            /*! ./dataRenderer */ "./src/classes/dataRenderer.js"
          );
        /* harmony import */ var _requiredDataGetter__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(
            /*! ./requiredDataGetter */ "./src/classes/requiredDataGetter.js"
          );
        ...
        class App {
          constructor() {
            ...
            this.localStorageManager =
              new _localStorageManager__WEBPACK_IMPORTED_MODULE_1__[
                "default"
              ]();
            this.textTranslator =
              new _textTranslator__WEBPACK_IMPORTED_MODULE_0__["default"](
                STATIC_TEXT_TRANSLATIONS,
                null
              );
            this.inputGetter = new _inputGetter__WEBPACK_IMPORTED_MODULE_2__[
              "default"
            ]();
            this.urlMaker = new _URLMaker__WEBPACK_IMPORTED_MODULE_3__[
              "default"
            ](URL_TYPES);
            this.dataFetcher = new _dataFetcher__WEBPACK_IMPORTED_MODULE_4__[
              "default"
            ]();
            this.errorNotifier =
              new _errorNotifier__WEBPACK_IMPORTED_MODULE_5__["default"]();
            this.jsonParser = new _jsonParser__WEBPACK_IMPORTED_MODULE_6__[
              "default"
            ]();
            this.dataRenderer = new _dataRenderer__WEBPACK_IMPORTED_MODULE_7__[
              "default"
            ](DOMElementsToHandleOnRender);
            this.requiredDataGetter =
              new _requiredDataGetter__WEBPACK_IMPORTED_MODULE_8__["default"]();
          }
            ...
            submitButton.addEventListener("click", async (e) => {
              if (weatherForm.checkValidity()) {
                ...
                const renderingParameters =
                  this.inputGetter.getRenderingParameters(
                    inputsForRenderingParameters
                  );

                const requiredData =
                  this.requiredDataGetter.getRequiredWeatherData({
                    data: allWeatherData,
                    renderingParameters,
                  });
      ...
      /***/ (
        ...
        class DataRenderer {
          ...
          #renderForecastWeather(daysData) {
            const forecastWeatherDiv =
              this._DOMElementsToHandleOnRender.forecast;
      ...
      /***/ (
        ...
        class RequiredDataGetter {
          ...
          #setPressureRelatedParams({
            ...
            requiredDataObject.pressure =
              allData.current[renderingParameters.pressure];
          }
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./styles.css */ "./src/styles.css");
    /* harmony import */ var _classes_app__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./classes/app */ "./src/classes/app.js");
